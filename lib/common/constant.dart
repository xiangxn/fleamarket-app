...
const ROUTE_MINE_HOME = 'mineHome';
const ROUTE_MINE_FAVORITE = 'mineFavorite';
const ROUTE_MINE_FOCUS= 'mineFocus';
const ROUTE_MINE_FANS = 'mineFans';
const ROUTE_MINE_PUBLISH = 'minePublish';
const ROUTE_MINE_BUY = 'mineBuy';
const ROUTE_MINE_SELL = 'mineSell';
const ROUTE_MINE_INVITE = 'mineInvite';
const ROUTE_MINE_BALANCES = 'mineBalances';
const ROUTE_MINE_KEYS = 'mineKeys';
const ROUTE_MINE_ADDRESS = 'mineAddress';
const ROUTE_EDIT_ADDRESS = 'editAddress';
const ROUTE_MINE_WITHDRAWAL = 'mineWithdrawal';
const ROUTE_EDIT_WITHDRAWAL = 'editWithdrawal';
const ROUTE_MINE_VOTE = 'mineVote';
