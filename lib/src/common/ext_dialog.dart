...
class ExtDialog{
  ...
  static TextStyle get _msgStyle => TextStyle(
    fontSize: 15,
    color: Colors.grey[700]
  );
  ...
  static Future<dynamic> _dialog(
    BuildContext context,
    String msg,
    String title,
    [int btnCount = 1]
  ){
    var locale = Provider.of<ExtLocale>(context, listen: false);
    return _baseDialog(
      context: context, 
      content: Column(
        ...
        children: <Widget>[
          Text(
            title ?? locale.translation('dialog.title'),
            style: _titleStyle
          ),
          Padding(
          ...
          Row(
            ...
            children: List.generate(btnCount, (inx) => inx).map((i){
              ...
              return FlatButton(
                ...
                child: Text(
                  isFirst ? locale.translation('dialog.ok') : locale.translation('dialog.cancel'), 
      ...
      content: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text(
              loadMsg ?? locale.translation('dialog.loading'),
              style: _msgStyle,
            ),
          )
        ],
