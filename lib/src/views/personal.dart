    ...
    return InkWell(
      ...
      child: Column(
        children: <Widget>[
          ...
          Text(mark, style: TextStyle(color: Colors.grey[600]),)
        ],
      ),
    );
  }
                  ...
                  children: <Widget>[
                    ...
                    LineButtonGroup(
                      ...
                      children: [
                        ...
                        LineButtonItem(
                          text: locale.translation('personal.mine_keys'), 
                          prefixIcon: Icons.vpn_key, 
                          onTap: () => model.pushNamed(MINE_KEYS_ROUTE)
                        ),
                        LineButtonItem(
                    ...
                    LineButtonGroup(
                      ...
                      children: [
                        LineButtonItem(
                          text: locale.translation('personal.version'), 
                          subText: model.extSystem.version, 
                          prefixIcon: Icons.info
                        ),
                        LineButtonItem(
                          text: locale.translation('personal.about'), 
                          prefixIcon: Icons.insert_emoticon, 
                          onTap: () => model.pushNamed(ABOUT_ROUTE)
                        )
                      ],
                    ),
                    Container(
