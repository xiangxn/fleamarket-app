...
import 'package:fleamarket/src/view_models/mine_sell_view_model.dart';
...
class MineSell extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return BaseView<MineSellViewModel>(
      model: MineSellViewModel(context),
      builder: (_, model, __){
        return Scaffold(
          appBar: AppBar(
            centerTitle: true,
            title: Text(model.locale.translation('title.mine_sell')),
