...
class PhotosSelector extends StatelessWidget{
  final String title;
  final int maxCount;
  final List<SimplePhoto> selectedPhotos;
          ...
          appBar: AppBar(
            ...
            actions: <Widget>[
              FlatButton(
                ...
                child: Text(locale.translation('photos.done'))
              )
            ],
          ),
          body: Column(
                      ...
                      child: TabBarView(
                        ...
                        children: [
                          GridView.builder(
                            ...
                            itemBuilder: (_, i){
                              SimplePhoto photo = model.photos[i];
                    ...
                    AnimatedPositioned(
                      ...
                      child: Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i){
                            SimplePhoto photo = model.selectedPhotos[i];
                            return GestureDetector(
                              onTap: () => model.selectPhoto(photo),
                              child: Container(
                                width: 70,
