                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                ExtCircleAvatar(model.goods.seller.head, 36, strokeWidth: 0,),
                                SizedBox(width: 8),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: <Widget>[
                                    Text(model.goods.seller.nickname, style: TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.bold
                                    )),
                                    Text(locale.translation('detail.location', [model.goods.position ?? '']), style: TextStyle(
                                      fontSize: 12,
                                      color: Colors.grey
                                    ))
                                  ],
