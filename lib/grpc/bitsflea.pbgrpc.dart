...
class BitsFleaClient extends $grpc.Client {
  ...
  static final _$upload = $grpc.ClientMethod<$0.FileRequest, $0.BaseReply>(
      ...
      ($core.List<$core.int> value) => $0.BaseReply.fromBuffer(value));
  static final _$createPayInfo =
      $grpc.ClientMethod<$0.PayInfoRequest, $0.BaseReply>(
          '/bitsflea.BitsFlea/CreatePayInfo',
          ($0.PayInfoRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.BaseReply.fromBuffer(value));
  static final _$logisticsInfo =
      $grpc.ClientMethod<$0.LogisticsRequest, $0.BaseReply>(
  ...
  static final _$getPhone =
      $grpc.ClientMethod<$0.GetPhoneRequest, $0.BaseReply>(
          ...
          ($core.List<$core.int> value) => $0.BaseReply.fromBuffer(value));
  static final _$getConfig = $grpc.ClientMethod<$0.SearchRequest, $0.BaseReply>(
  ...
  $grpc.ResponseFuture<$0.BaseReply> createPayInfo($0.PayInfoRequest request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$createPayInfo, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }

  $grpc.ResponseFuture<$0.BaseReply> logisticsInfo($0.LogisticsRequest request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$logisticsInfo, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.BaseReply> getConfig($0.SearchRequest request,
      {$grpc.CallOptions options}) {
...
abstract class BitsFleaServiceBase extends $grpc.Service {
  ...
  BitsFleaServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.FileRequest, $0.BaseReply>(
        ...
        ($0.BaseReply value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.PayInfoRequest, $0.BaseReply>(
        'CreatePayInfo',
        createPayInfo_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.PayInfoRequest.fromBuffer(value),
        ($0.BaseReply value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.LogisticsRequest, $0.BaseReply>(
        'LogisticsInfo',
        logisticsInfo_Pre,
        false,
        false,
  ...
  $async.Future<$0.BaseReply> createPayInfo_Pre(
      $grpc.ServiceCall call, $async.Future<$0.PayInfoRequest> request) async {
    return createPayInfo(call, await request);
  }

  $async.Future<$0.BaseReply> logisticsInfo_Pre($grpc.ServiceCall call,
      $async.Future<$0.LogisticsRequest> request) async {
  ...
  $async.Future<$0.BaseReply> getConfig_Pre(
      $grpc.ServiceCall call, $async.Future<$0.SearchRequest> request) async {
  ...
  $async.Future<$0.BaseReply> createPayInfo(
  ...
  $async.Future<$0.BaseReply> getConfig(
      $grpc.ServiceCall call, $0.SearchRequest request);
}
